...
ActiveRecord::Schema.define(version: 2021_08_05_031217) do
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "products_variation_id"
    t.index ["order_id"], name: "index_order_items_on_order_id"
    t.index ["products_variation_id"], name: "index_order_items_on_products_variation_id"
  end
  ...
  add_foreign_key "order_items", "products_variations"
